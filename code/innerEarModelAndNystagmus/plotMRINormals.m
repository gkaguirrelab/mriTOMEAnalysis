function plotMRINormals(lateralMRILeft, lateralMRIRight, ...
    ...
    %    Inputs:
    %        canal names (e.g. lateralMRILeft) is the variable loaded by
    %        loadMRINormals.m function. 
    %        dashed - If true, plot with dashed lines
    %        thick - If true, plot with thick lines
