function [meanSpeed,SD,eligible] = find_slope(nameTag,variable,acquisition)
% Finds the median slope for an acquisition
%
% Syntax:
...
%   chunks with the highest RMSEs. This cycle is repeated 10 times until a
%   meanSpeed and SD is calculated.
...
%
% Outputs:
%   meanSpeed             - Double. Returns mean of the slopes plotted.
%   SD                    - Double. Returns mean RMSE.

% Examples:
%	[meanSpeed, SD] = find_slope("01_081916",1,path1);
...
% Output
meanSpeed = tempSlope*1000;
SD = mean(RMSE);
eligible = length(time_good)/20160>0.10;
