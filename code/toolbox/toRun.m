% analyzeRest_wholeBrain('TOME_3003', 'rfMRI_REST_AP_Run1');
% analyzeRest_wholeBrain('TOME_3003', 'rfMRI_REST_PA_Run2');
% analyzeRest_wholeBrain('TOME_3003', 'rfMRI_REST_AP_Run3');
% analyzeRest_wholeBrain('TOME_3003', 'rfMRI_REST_PA_Run4');

% analyzeRest_wholeBrain('TOME_3003', 'rfMRI_REST_AP_Run1_hp2000_clean', 'skipPhysioMotionWMVRegression', true)
% analyzeRest_wholeBrain('TOME_3003', 'rfMRI_REST_PA_Run2_hp2000_clean', 'skipPhysioMotionWMVRegression', true)
% analyzeRest_wholeBrain('TOME_3003', 'rfMRI_REST_AP_Run3_hp2000_clean', 'skipPhysioMotionWMVRegression', true)
% analyzeRest_wholeBrain('TOME_3003', 'rfMRI_REST_PA_Run4_hp2000_clean', 'skipPhysioMotionWMVRegression', true)

analyzeWholeBrain('TOME_3003', 'rfMRI_REST_AP_Run1', 'fileType', 'CIFTI');
