...
%% Run FreeSurfer bit
system(['bash makeV1Mask_fmriPrep ', subjectID, ' "', anatDir, '" "', freeSurferDir, '" "', functionalDir, '" "', outputDir, '" "', runName, '"']);
...
subjectID_unsplit = strsplit(subjectID, '_');
subjectID_unsplit = [subjectID_unsplit{1}, subjectID_unsplit{2}];

restScan = MRIread(fullfile(functionalDir, ['sub-', subjectID_unsplit, '_ses-', runName, '_bold_space-T1w_preproc.nii.gz']));
