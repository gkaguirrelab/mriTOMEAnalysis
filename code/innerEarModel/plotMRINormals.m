function plotMRINormals(lateralMRILeft, lateralMRIRight, ...
    ...
    elseif true(thick)
        ...
        quiver3(-3,0,0,posteriorMRILeft(1),posteriorMRILeft(2),posteriorMRILeft(3),'y','linewidth',5,'color', [155 135 12]/255)
        ...
        quiver3(0,0,0,posteriorMRIRight(1),posteriorMRIRight(2),posteriorMRIRight(3),'y','linewidth',5,'color', [155 135 12]/255)
        hold off
