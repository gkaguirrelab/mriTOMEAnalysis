function plotMRINormals(lateralMRILeft, lateralMRIRight, ...
    ...
    if true(dashed)
        ...
        quiver3(-3,0,0,posteriorMRILeft(1),posteriorMRILeft(2),posteriorMRILeft(3),'b','LineStyle', '--')
    ...
    elseif true(thick)
        ...
        quiver3(-3,0,0,posteriorMRILeft(1),posteriorMRILeft(2),posteriorMRILeft(3),'b','linewidth',5,'color', [0 0 0.5])
        ...
        quiver3(0,0,0,posteriorMRIRight(1),posteriorMRIRight(2),posteriorMRIRight(3),'b','linewidth',5,'color', [0 0 0.5])
        hold off
